...
jit-2.0:
	docker build -t=$(IMAGE):jit-2.0 -f jit-2.0/Dockerfile .
	docker build -t=$(IMAGE):jit-2.0-alpine -f jit-2.0/alpine/Dockerfile .

jit-2.1:
	docker build -t=$(IMAGE):jit-2.1 -f jit2.1/Dockerfile .
	docker build -t=$(IMAGE):jit-2.1-alpine -f jit-2.1/alpine/Dockerfile .
